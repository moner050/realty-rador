...
**Interfaces:**
- Consumes: `item.detail_checked_at`, `item.parking_per_household_x100`, `item.monthly_management_cost`, and `item.nearest_subway_walk_minutes`.
...
- [ ] **Step 3: Add a narrow Jinja macro and use it for the three fields**
